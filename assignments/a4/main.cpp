...
public:
    ...
    void Create_Shining_Scene()
    {
        ...
        auto banana = Add_Obj_Mesh_Object("banana.obj");
        //// set transform
        Matrix4f t3;
        t3 << 0.5, 0., 0., -2.,
            0., 0.5, 0., -0.5,
            0., 0., 0.5, 0.,
            0., 0., 0., 1.;
        banana->Set_Model_Matrix(t3);
        //// set material properties
        banana->Set_Ka(Vector3f(0.87f, 0.76f, 0.15f));
        banana->Set_Kd(Vector3f(0.87f, 0.76f, 0.15f));
        banana->Set_Ks(Vector3f(0.2f, 0.2f, 0.2f));
        banana->Set_Shininess(30.f);
